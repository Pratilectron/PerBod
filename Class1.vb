...
#Region " Control Help - Movement & Flicker Control "
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As System.Windows.Forms.MouseEventArgs)
        MyBase.OnMouseDown(e)
        If e.Button = MouseButtons.Left And New Rectangle(0, 0, Width, Header).Contains(e.Location) Then
...
Class SharpProgreSsBar
    ...
    'Private _GlowColor As Color = Color.LimeGreen
    ...
    'Private _BackgroundColor As Color = Color.LimeGreen
    Private _StartColor As Color = Color.FromArgb(110, 110, 110)
    'Private _StartColor As Color = Color.LimeGreen
#Region "Properties"
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim s2 As New LinearGradientBrush(New Rectangle(0, 2, Width - 3, 50), Color.LimeGreen, Color.FromArgb(50, Color.White), 90S)
